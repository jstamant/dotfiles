...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(;; ----------------------------------------------------------------
     ...
     haskell
     helm
     html  ; for editing HTML and CSS via web-mode
     javascript
     ;; lsp
     markdown
     multiple-cursors
     nginx ; for nginx-mode
     org
     react
     rust ; for .toml files
     (shell :variables
