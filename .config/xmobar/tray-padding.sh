...
# Detects the width of the system tray's window (xprop name 'panel')
...
# `Run Com "/path/to/tray-padding.sh" [] "traypadding" 10`
# and use `%traypadding%` in your template.
...
/* leave room for the system tray. It is dynamically */
...
# Width of the system tray window
width=$(xprop -name panel | grep 'program specified minimum size' | cut -d ' ' -f 5)

# Icon file name
iconfile="/tmp/tray-padding-${width}px.xpm"
